          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sky-200">info@uavclub.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-sky-300" />
                <span className="text-sky-200">+1 (555) 123-4567</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="w-5 h-5 text-sky-300" />
                <span className="text-sky-200">Tech Campus, Innovation Hub</span>
              </div>
            </div>
          </motion.div>
        </div>
